 ...
 * uint8_t red - The red value between 128 (off) and 255 (full on).
 * uint8_t green - The green value between 128 (off) and 255 (full on).
 * uint8_t blue - The blue value between 128 (off) and 255 (full on).
 */
