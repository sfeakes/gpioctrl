(function() {
	...
	var width = c.width = c.height = 400,
        ...
        circleOffset = 10,
        diameter = 280,                  //width-circleOffset*2,
    ...
    var width = c.width = c.height = 200,
        ...
        radius = diameter / 2,
        radiusPlusOffset = radius + circleOffset,          //radius + circleOffset
        radiusSquared = radius * radius,
        two55 = 255,
        currentY = oneHundred,
        currentX = -currentY,
    ...
    function redraw(e) {
		...
		rgb = hsvToRgb((theta + PI) / PI2, sqrt(d) / radius, input.value / oneHundred);
		
		label.textContent = rgb[3];
		...
		sendtoserver ( hsvToRgb((theta + PI) / PI2, sqrt(d) / radius, input.value / oneHundred) );
        */
	...
	function sendtoserver(rgb) {
      ...
      $http.open('GET', location.protocol + '//' + location.host + '/led?r=' + rgb[0] + "&g=" + rgb[1] + "&b=" +rgb[2]);
	  //$http.open('GET', 'http://thunderbolt1/led?r=' + rgb[0] + "&g=" + rgb[1] + "&b=" +rgb[2]);
      $http.send(null); 
	}
